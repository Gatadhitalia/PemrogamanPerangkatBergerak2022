...
public class HistoryAdapter extends RecyclerView.Adapter<HistoryAdapter.RiwayatViewHolder> {
    private final ArrayList<ListHistory> listHistory;
    ...
    public HistoryAdapter(ArrayList<ListHistory> rwytList) {
        listHistory = rwytList;
    }
    ...
    public RiwayatViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        RiwayatViewHolder holder= new RiwayatViewHolder(inflater.inflate(R.layout.activity_history, parent, false));
    ...
    public void onBindViewHolder(RiwayatViewHolder holder, int position) {
        ListHistory currentItem = listHistory.get(position);
